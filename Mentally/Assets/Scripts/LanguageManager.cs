...
public class LanguageManager
{
    ...
    string[,] names = new string[8, 9] {
        ...
        "Por favor, iros. Por favor, iros", "", "Estoy intentando relajarme", "Me siento solo pero está bien", "Ojalá pudiera salir", "Mañana iré a comprar algo" },
         //Depression
        ...
        "", "", "Es duro levantarme", "Creo que hoy estoy mejor", "En realidad no", "Llorar está bien"} 
