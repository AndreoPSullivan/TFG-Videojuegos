...
public class LanguageManager
{
    ...
    string[,] texts = new string[8, 10] {
        ...
        ///ENG 
        //General 
        {"Select a character", "Time to go to bed", "I can't go to bed yet", "Let's switch on the lights", "Let's switch off the lights", "Open the door", "Wait until the party ends", "WIP - Work in progress", "", "Paused" },
        //TCA
        ...
        { "I don't feel fine, but at least I'm going to therapy on Monday", "Today I don't want to leave bed, I hate my life", "If only I could find something to have fun with",
            "Tomorrow will be better. Or not", "", "I don't want to eat more", "It's hard to get up", "I think I'm better today", "Not really", "Crying is ok"}, 
        
        ///ESP 
        //General 
        {"Selecciona un personaje", "Es hora de ir a la cama", "No puedo irme a la cama ya", "Toca encender las luces", "Hora de apagar las luces", "Abre la puerta", "Espera hasta que acabe la fiesta", "WIP - Trabajo en progreso", "", "Pausado"
        },
        //TCA
        ...
        "Mañana será mejor. O no", "", "No quiero comer más", "Es duro levantarme", "Creo que hoy estoy mejor", "En realidad no", "Llorar está bien"} 
